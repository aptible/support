Aptible takes nightly (encrypted) backups of all production databases, along with intermediate point-in-time recovery snapshots for several database types.
